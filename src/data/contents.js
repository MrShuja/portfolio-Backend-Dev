export const headerContent = {
  ...
  export const aboutContent = {
    ...
    focus: [
      ...
      "Secure and optimized query handling",
  ...
  export const portfolioContent = [
    ...
    },
    {
      ...
      description: 'An online tool to edit, merge, and convert PDFs using React and SCSS.',
      repo: 'https://github.com/yourusername/pdf-master',
    },
    {
    ...
    {
      title: 'Weather App',
      description: 'A weather forecast app using OpenWeather API and Tailwind UI.',
...
export const footerContent = {
  text: "© 2025 Shuja. All rights reserved.",
  sections: [
    {
      title: "Quick Links",
      links: [
